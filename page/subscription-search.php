...
if (isset($refCustomer)) {
    ...
    if ($response->is_success()) {
        ...
        if (isset($refOffer)) {
            ...
            // If success:
            if ($response->is_success()) {
                $urlLink = "/page/subscription.php?refCustomer=" . $refCustomer . "&refOffer=";
...
// If reference subscription is not set:
    ...
    $urlLink = "/page/subscription-search.php?refCustomer=";
    $urlPagination = "../page/subscription-search.php?page=";
